...
class AdafruitGETAcesso extends AdafruitGET {
  AdafruitGETAcesso(
      {super.username,
      super.owner,
      super.id,
      ...
      super.group,
      super.groups,
      super.feedWebhookReceivers,
      super.feedStatusChanges,
      this.acesso});

  Acesso? acesso;

  factory AdafruitGETAcesso.fromRawJson(String str) =>
      AdafruitGETAcesso.fromJson(json.decode(str));

  factory AdafruitGETAcesso.fromJson(Map<String?, dynamic> json) =>
      AdafruitGETAcesso(
          username: json["username"],
          owner: Owner.fromJson(json["owner"]),
          id: json["id"],
          ...
          feedStatusChanges:
              List<dynamic>.from(json["feed_status_changes"].map((x) => x)),
          acesso: Acesso.fromRawJson(DateTime.parse(json["updated_at"]), json["last_value"]));
}

class AdafruitGETEstado extends AdafruitGET {
  AdafruitGETEstado(
      {super.username,
      super.owner,
      super.id,
  ...
  EstacaoEstado? estacao;

  factory AdafruitGETEstado.fromRawJson(String str) =>
      AdafruitGETEstado.fromJson(json.decode(str));

  factory AdafruitGETEstado.fromJson(Map<String?, dynamic> json) =>
      AdafruitGETEstado(
          username: json["username"],
          owner: Owner.fromJson(json["owner"]),
          id: json["id"],
          ...
          feedStatusChanges:
              List<dynamic>.from(json["feed_status_changes"].map((x) => x)),
          estacao: EstacaoEstado.fromRawJson(json["last_value"]));
}
...
class Acesso {
  ...
  factory Acesso.fromRawJson(DateTime date, String str) => Acesso.fromJson(date, json.decode(str));

  factory Acesso.fromJson(DateTime date, Map<String, dynamic> json) => Acesso(
...
class EstacaoEstado {
  EstacaoEstado({this.id, this.nome, this.estado});

  int? id;
  String? nome;
  String? estado;

  factory EstacaoEstado.fromRawJson(String str) =>
      EstacaoEstado.fromJson(json.decode(str));

  factory EstacaoEstado.fromJson(Map<String, dynamic> json) => EstacaoEstado(
        id: json["id"],
        nome: json["nome"],
        estado: json["estado"],
      );
